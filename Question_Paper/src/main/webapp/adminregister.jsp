...
<body>
	...
	<form:form action="/addAdminDetails" method="post"
		...
		<div class="container">
			<table>
				...
				<tr>
					...
					<td><form:input type="number" placeholder="Enter Contact Number"
							path="contactNumber" pattern="[6-9]{1}[0-9]{9}" required="required" /></td>
				</tr>
		...
		<table>
			...
			<tr>
				...
				<td><form:input type="text" path="birthCity" required="required" /></td>
			</tr>
			...
			<tr>
				...
				<td><form:input type="text" path="favoriteFood" required="required" /></td>
			</tr>
			<tr>
				<td></td>
